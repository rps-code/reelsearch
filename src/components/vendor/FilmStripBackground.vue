<template>
  <div
    ref="containerRef"
    class="beams-container w-full h-full relative"
  />
</template>

<script setup lang="ts">
  /* Fu nfact: this file is from VueBits and uses three.js - this was my first time using VueBits after a colleague recommended it to me! */
...
`
  ...
  vec3 getNormal(vec3 pos) {
    ...
    gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`
      ...
      material: { fog: true },
      uniforms: {
        diffuse: new THREE.Color(...hexToNormalizedRGB('#111827')),
